...
/* @var $searchModel app\models\MovesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Moves');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="moves-index box center-block box-primary" style="margin-top: 20px">
    ...
    <div class="box-header with-border">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4 col-xs-4" style="text-align: right; padding-right: 20px; margin-top: 25px">
                <?= Html::a(Yii::t('app', 'Criar Moves'), ['create'], ['class' => 'btn btn-success']) ?>
            </div>
        </div>
