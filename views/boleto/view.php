...
$this->title = $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Boleto'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="boleto-view  box center-block box-primary" style="margin-top: 20px; padding: 20px">
    ...
    <div class="box-header with-border">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4 col-xs-4">
                <h1 style="text-align: center"><?=   Yii::t('app', 'Boleto') . ": " . Html::encode($this->title) ?></h1>
            </div>
