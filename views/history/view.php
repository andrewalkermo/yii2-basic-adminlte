...
?>
<div class="history-view  box center-block box-primary" style="margin-top: 20px; padding: 20px">
    ...
    <div class="box-header with-border">
        <div class="row">
            ...
            <div class="col-sm-4">
                <h1 style="text-align: center"><?=   Yii::t('app', 'History') . ": " . Html::encode($this->title) ?></h1>
            </div>
