...
/* @var $searchModel app\models\InvestedSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Invested');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="invested-index box center-block box-primary" style="margin-top: 20px">
    ...
    <div class="box-header with-border">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4 col-xs-4" style="text-align: right; padding-right: 20px; margin-top: 25px">
                <?= Html::a(Yii::t('app', 'Criar Invested'), ['create'], ['class' => 'btn btn-success']) ?>
            </div>
        </div>
