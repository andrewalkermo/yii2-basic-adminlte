...
$this->title = Yii::t('app', 'Paypal');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="paypal-index box center-block box-primary" style="margin-top: 20px">
    ...
    <div class="box-header with-border">
        <div class="row">
            ...
            <div class="col-sm-4" style="text-align: right; padding-right: 20px; margin-top: 25px">
                <?= Html::a(Yii::t('app', 'Criar Paypal'), ['create'], ['class' => 'btn btn-success']) ?>
            </div>
        </div>
